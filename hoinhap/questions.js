window.HOINHAP_QUESTIONS = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "c",
        "text": "Nhà máy MHF tại ấp Phú Lộc, xã Hòa Hiệp, TP.HCM (Bà Rịa – Vũng Tàu cũ)."
      },
      {
        "key": "d",
        "text": "Tất cả các ý trên."
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "b",
        "text": "Kho vận đường Trịnh Quang Nghị, TP.HCM (huyện Bình Chánh cũ) phù hợp khi cần xử lý hàng hóa, giao nhận hoặc hỗ trợ vận hành."
      },
      {
        "key": "c",
