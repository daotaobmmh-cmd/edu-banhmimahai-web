...
def create_document():
    ...
    r.bold = True
    r = p_meta.add_run("Gần gũi, ấm áp, tập trung chia sẻ kinh nghiệm thực chiến từ các điểm bán thành công để đối tác tự tin vận hành đông khách (Không nặng về thi cử chứng nhận)")
    ...
    print(f"SUCCESS: Value-driven AI Voice Script Word saved to Desktop at {desktop_docx}")
